...
def train_net(data, model, loss_func, optimizer, timesteps, batch_size, max_epochs,
    ...
    for epoch in range(max_epochs):
        ...
        for iter in range(iter_start, iter_end):
            ...
            loss = None
            #########################################################################################
            # TODO: Update the parameters of the network by:                                        #
            #           (1) performing a forward pass to compute the outputs                        #
            #           (2) computing the loss and performing a backward pass to compute gradients  #
